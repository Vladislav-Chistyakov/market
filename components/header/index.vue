    ...
    <ul class="ml-auto flex flex-row items-center gap-3">
      <li>
        <button
            ...
            aria-label="Wishlist"
        >
          <svg class="flex" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        ...
        >
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.00016 9.66668C10.3013 9.66668 12.1668 7.8012 12.1668 5.50001C12.1668 3.19882 10.3013 1.33334 8.00016 1.33334C5.69898 1.33334 3.8335 3.19882 3.8335 5.50001C3.8335 7.8012 5.69898 9.66668 8.00016 9.66668ZM8.00016 9.66668C4.31826 9.66668 1.3335 11.9053 1.3335 14.6667M8.00016 9.66668C11.6821 9.66668 14.6668 11.9053 14.6668 14.6667" stroke="#807D7E" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        </button>
      </li>
