...
<template>
  <div class="w-full flex flex-col gap-[26px]">
    ...
    <div class="relative h-[3px] bg-[#B3B1B2] rounded">
      ...
      <div
        ...
        :style="{
          ...
          right: (100 - (maxValue - props.min) / (props.max - props.min) * 100) + '%'
        }"
      ></div>
    ...
    <div class="flex justify-between text-sm gap-[30px]">
      <div class="w-full bg-transparent border border-[#CBC9CA] rounded-lg pt-[6px] pb-[7px] px-1 text-center">
        <span class="font-causten text-[14px] leading-5 text-[#3C4242] font-semibold">
          ${{ minValue }}
        </span>
      </div>
