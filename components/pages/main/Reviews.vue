  ...
  <div class="reviews container xl:max-w-[1440px]">
    ...
    >
      <swiper-slide
          ...
          class="pb-[43px]"
      >
        <div class="h-full flex flex-col gap-[15px] p-[21px_22px_21px_21px] border-2 border-gray-border rounded-[10px]">
          <div class="flex justify-between gap-2.5">
            <img :src="item.srcImg" height="58px" width="58px" />

            <ul class="flex flex-row items-center h-fit">
              <li v-for="(star, starIndex) in listStar(item.stars)" :key="starIndex">
                <img v-show="star === 'full'" src="@/assets/images/pages/main/reviews/star_full.svg" height="23.2px" width="23.2px" />
                <img v-show="star === 'half'" src="@/assets/images/pages/main/reviews/star_half.svg" height="23.2px" width="23.2px" />
                <img v-show="star === 'outline'" src="@/assets/images/pages/main/reviews/star_outline.svg" height="23.2px" width="23.2px" />
              </li>
            </ul>
          </div>
