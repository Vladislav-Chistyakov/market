    ...
    >
      <swiper-slide class="text-white">
        ...
        >
          ...
          <nuxt-link
            to="/products/female"
            class="block w-fit bg-white rounded-[8px] px-8 py-4 xl:px-[72px] xl:py-[16px] text-text-black font-causten text-[20px] leading-6 xl:text-[24px] xl:leading-7 font-bold"
          >
            Shop Now
          </nuxt-link>
        </div>
