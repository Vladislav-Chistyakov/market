  ...
  >
    ...
    >
      ...
      >
        <li>
          <b
            class="block font-causten font-bold text-gray-50 text-[28px] leading-[32px] mb-[39px]"
          >
            Need Help
          </b>
          ...
          <ul class="flex flex-col gap-[22px]">
            <li
              class="font-causten font-bold text-gray-50 text-[18px] leading-[22px]"
            >
              Contact Us
            </li>
      ...
      >
        ...
        <li>
          <nuxt-link>
            <img src="@/assets/images/footer/social/inst.svg" alt="instagram" />
          </nuxt-link>
        </li>

        <li>
          <nuxt-link>
            <img src="@/assets/images/footer/social/tw.svg" alt="twitter" />
          </nuxt-link>
        </li>

        <li>
          <nuxt-link>
            <img src="@/assets/images/footer/social/in.svg" alt="link in" />
          </nuxt-link>
        </li>
      </ul>
      ...
      <div>
        <strong
          class="block mb-3 md:mb-5 lg:mb-6 xl:mb-9 font-causten font-bold text-gray-50 text-[28px] leading-8"
        >
          Download The App
        </strong>
        ...
        <ul class="flex items-center gap-5 pl-1">
          ...
          <li class="flex">
            <button>
              <img src="@/assets/images/footer/app-store.svg" alt="app store" />
            </button>
          </li>
        </ul>
      </div>
    ...
    <div class="container xl:max-w-[1220px] pr-[62px]">
      ...
      >
        ...
        <img src="@/assets/images/footer/arrow.svg" alt="arrow" />
      </button>
    </div>
