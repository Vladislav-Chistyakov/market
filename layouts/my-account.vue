  ...
  <div class="lg:max-w-[1024px] xl:max-w-[1440px] lg:mx-auto container">
    <div>
      <div>
        ...
        <p class="font-core-sans-c text-[13px] leading-[15px] text-text-gray-200 mb-[30px]">
        ...
        <ul>
          <li>
            ...
            >
              <img src="@/assets/images/pages/my-account/my-orders.svg" alt="my-orders">

              <span class="block font-causten font-semibold text-[18px] leading-[20px] text-text-gray-200">
                My orders
              </span>
            </NuxtLink>
          </li>
          ...
          <li>
            ...
            >
              <img src="@/assets/images/pages/my-account/heart.svg" alt="heart">
          ...
          <li>
            ...
            >
              <img src="@/assets/images/pages/my-account/sign-out.svg" alt="sign-out">
